...
void StgStageScriptObjectManager::RenderObject(int priMin, int priMax) {
	/*
		...
		shared_ptr<StgStageInformation> stageInfo = stageController_->GetStageInformation();
...
int StgStageScriptObjectManager::CreatePlayerObject() {
	//自機オブジェクト生成
	ptrObjPlayer_.reset(new StgPlayerObject(stageController_));
...
static const std::vector<function> stgStageFunction = {
	...
	{ "CreateShotC1", StgStageScript::Func_CreateShotC1, 7 },
	{ "CreateShotC2", StgStageScript::Func_CreateShotC2, 12 },
	{ "CreateShotOC1", StgStageScript::Func_CreateShotOC1, 6 },
	...
	{ "ObjMove_AddPatternC4", StgStageScript::Func_ObjMove_AddPatternC4, 13 },
	...
	{ "ObjMove_SetRelativeX", StgStageScript::Func_ObjMove_SetRelativeX, 2 },
	{ "ObjMove_SetRelativeY", StgStageScript::Func_ObjMove_SetRelativeY, 2 },
	{ "ObjMove_GetRelativeX", StgStageScript::Func_ObjMove_GetRelativeX, 1 },
	{ "ObjMove_GetRelativeY", StgStageScript::Func_ObjMove_GetRelativeY, 1 },
	...
	{ "ObjMoveParent_SetRotationSpeed", StgStageScript::Func_ObjMoveParent_SetRotationSpeed, 2 },
	...
	{ "ObjCrLaser_GetNodeWidthScale", StgStageScript::Func_ObjCrLaser_GetNodeWidthScale, 2 },
	...
	{ "ObjCrLaser_SetNodeWidthScale", StgStageScript::Func_ObjCrLaser_SetNodeWidthScale, 3 },
...
StgStageScript::StgStageScript(StgStageController* stageController) : StgControlScript(stageController->GetSystemController()) {
	...
	auto scriptManager = std::dynamic_pointer_cast<StgStageScriptManager>(scriptManager_);
	SetObjectManager(scriptManager->GetObjectManager());
}
StgStageScript::~StgStageScript() {}

shared_ptr<StgStageScriptObjectManager> StgStageScript::GetStgObjectManager() {
	auto scriptManager = std::dynamic_pointer_cast<StgStageScriptManager>(scriptManager_);
...
gstd::value StgStageScript::Func_GetReplayFps(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatValue(fps);
}
...
gstd::value StgStageScript::Func_SetPlayerSpeed(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgPlayerObject* objPlayer = script->stageController_->GetPlayerObject().get();
	if (objPlayer) {
		double speedFast = argv[0].as_float();
		double speedSlow = argv[1].as_float();
...
gstd::value StgStageScript::Func_GetPlayerSpeed(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatArrayValue(listValue, 2U);
}
gstd::value StgStageScript::Func_GetPlayerClip(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatArrayValue(listValue, 4);
}
...
gstd::value StgStageScript::Func_GetEnemyIntersectionPosition(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	for (auto itr = mapPos.begin(); (itr != mapPos.end()) && (countRes > 0); ++itr) {
		...
		gstd::value v = script->CreateFloatArrayValue(listPosRes, 2U);
		listV.push_back(v);
		--countRes;
	}
...
gstd::value StgStageScript::Func_DeleteShotAll(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	stageController->GetShotManager()->DeleteInCircle(typeDel, typeTo, 
		StgShotObject::OWNER_ENEMY, 0, 0, {});
...
gstd::value StgStageScript::Func_DeleteShotInCircle(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	stageController->GetShotManager()->DeleteInCircle(typeDel, typeTo, 
		StgShotObject::OWNER_ENEMY, posX, posY, radius);
...
gstd::value StgStageScript::Func_CreateShotB2(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (stageController->GetShotManager()->GetShotCountAll() < StgShotManager::SHOT_MAX) {
		...
		if (id != ID_INVALID) {
			...
			double speedX = argv[2].as_float();
			double speedY = argv[3].as_float();
			double accelX = argv[4].as_float();
			double accelY = argv[5].as_float();
			double maxSpeedX = argv[6].as_float();
			double maxSpeedY = argv[7].as_float();
...
gstd::value StgStageScript::Func_CreateShotC1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	...
	if (stageController->GetShotManager()->GetShotCountAll() < StgShotManager::SHOT_MAX) {
		...
		if (id != ID_INVALID) {
			...
			int idShot = argv[5].as_int();
			int delay = argv[6].as_int();
			int typeOwner = script->GetScriptType() == TYPE_PLAYER ?
				StgShotObject::OWNER_PLAYER : StgShotObject::OWNER_ENEMY;
			...
			ref_unsync_ptr<StgMovePattern_XY_Angle> pattern(new StgMovePattern_XY_Angle(obj.get()));
			pattern->SetSpeedX(speedX);
			pattern->SetSpeedY(speedY);
			pattern->SetAngleOffset(Math::DegreeToRadian(angOff));
			obj->SetPattern(pattern);
		}
	}
	return script->CreateIntValue(id);
}
gstd::value StgStageScript::Func_CreateShotC2(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	...
	if (stageController->GetShotManager()->GetShotCountAll() < StgShotManager::SHOT_MAX) {
		...
		if (id != ID_INVALID) {
			...
			pattern->SetMaxSpeedY(maxSpeedY);
			pattern->SetAngleOffset(Math::DegreeToRadian(angOff));
			pattern->SetAngularVelocity(Math::DegreeToRadian(angVel));
			obj->SetPattern(pattern);
		}
	}
	return script->CreateIntValue(id);
}
gstd::value StgStageScript::Func_CreateShotOC1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
...
gstd::value StgStageScript::Func_CreateLooseLaserA1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (stageController->GetShotManager()->GetShotCountAll() < StgShotManager::SHOT_MAX) {
		...
		if (id != ID_INVALID) {
			...
			double speed = argv[2].as_float();
			double angle = argv[3].as_float();
			int length = argv[4].as_float();
			int width = argv[5].as_float();
...
gstd::value StgStageScript::Func_SetShotIntersectionLine(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgIntersectionManager* intersectionManager = stageController->GetIntersectionManager();
	float px1 = argv[0].as_float();
	float py1 = argv[1].as_float();
	float px2 = argv[2].as_float();
	float py2 = argv[3].as_float();
	float width = argv[4].as_float();
...
gstd::value StgStageScript::Func_GetShotDataInfoA1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (shotData == nullptr) {
		...
		case INFO_COLLISION:
			return script->CreateFloatValue(0);
		case INFO_COLLISION_LIST:
		{
			std::vector<gstd::value> listValue;
			int list[3] = { 0, 0, 0 };
			listValue.push_back(script->CreateFloatArrayValue(list, 3U));
		...
		case INFO_COLLISION:
		{
			...
			return script->CreateFloatValue(radius);
		}
		case INFO_COLLISION_LIST:
		{
			auto& listCircle = shotData->GetIntersectionCircleList();
			...
			for (auto& iCircle : listCircle) {
				...
				listValue.push_back(script->CreateFloatArrayValue(listData, 3U));
			}
			return script->CreateValueArrayValue(listValue);
		}
		case INFO_IS_FIXED_ANGLE:
...
gstd::value StgStageScript::Func_CreateItemA2(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (id != ID_INVALID) {
		...
		double posX = argv[1].as_float();
		double posY = argv[2].as_float();
		D3DXVECTOR2 to = D3DXVECTOR2(argv[3].as_float(), argv[4].as_float());
...
gstd::value StgStageScript::Func_CollectItemsInCircle(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	float cx = argv[0].as_float();
	float cy = argv[1].as_float();
	float cr = argv[2].as_float();
...
gstd::value StgStageScript::Func_StartItemScript(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	shared_ptr<ManagedScript> idScript = scriptManager->LoadScript(scriptManager, path, StgStageScript::TYPE_ITEM);
...
gstd::value StgStageScript::Func_ObjMove_SetSpeed(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		...
		if (pattern) {
			...
			{
				double speedMul = speed / pattern->GetSpeed();
				if (pattern->GetType() == StgMovePattern::TYPE_XY) {
					StgMovePattern_XY* patternXY = (StgMovePattern_XY*)pattern;
					patternXY->SetSpeedX(patternXY->GetSpeedX() * speedMul);
					patternXY->SetSpeedY(patternXY->GetSpeedY() * speedMul);
				}
				else {
					StgMovePattern_XY_Angle* patternXYA = (StgMovePattern_XY_Angle*)pattern;
					patternXYA->SetSpeedXY(patternXYA->GetSpeedX() * speedMul, patternXYA->GetSpeedY() * speedMul);
				}
				goto lab_return;
			}
			}
...
gstd::value StgStageScript::Func_ObjMove_SetAngle(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		double angle = Math::DegreeToRadian(argv[1].as_float());
		...
		if (pattern) {
			...
			case StgMovePattern::TYPE_XY_ANG:
			{
				...
				if (pattern->GetType() == StgMovePattern::TYPE_XY) {
					...
					StgMovePattern_XY_Angle* patternXYA = (StgMovePattern_XY_Angle*)pattern;
					patternXYA->SetSpeedXY(cos(angle) * speed, sin(angle) * speed);
				}
				goto lab_return;
			}
			}
...
gstd::value StgStageScript::Func_ObjMove_SetAcceleration(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		...
		if (pattern) {
			...
			case StgMovePattern::TYPE_XY_ANG:
			{
				if (pattern->GetType() == StgMovePattern::TYPE_XY) {
					...
					double accX = patternXY->GetAccelerationX();
					double accY = patternXY->GetAccelerationY();
					double accMul = accel / hypot(accX, accY);
					patternXY->SetAccelerationX(accX * accMul);
					patternXY->SetAccelerationY(accY * accMul);
				}
				else {
					StgMovePattern_XY_Angle* patternXYA = (StgMovePattern_XY_Angle*)pattern.get();
					double accX = patternXYA->GetAccelerationX();
					double accY = patternXYA->GetAccelerationY();
					double accMul = accel / hypot(accX, accY);
					patternXYA->SetAccelerationX(accX * accMul);
					patternXYA->SetAccelerationY(accY * accMul);
				}
				goto lab_return;
			}
			}
		...
		pattern.reset(new StgMovePattern_Angle(obj));
		obj->AddPattern(0, pattern);
lab_set:
		((StgMovePattern_Angle*)pattern.get())->SetAcceleration(accel);
	}
lab_return:
	return value();
}
	...
	if (obj) {
		...
		if (pattern) {
			...
			case StgMovePattern::TYPE_XY_ANG:
			{
				if (pattern->GetType() == StgMovePattern::TYPE_XY) {
					StgMovePattern_XY* patternXY = (StgMovePattern_XY*)pattern.get();
					double mspeedX = patternXY->GetMaxSpeedX();
					double mspeedY = patternXY->GetMaxSpeedY();
					double mspeedMul = speed / hypot(mspeedX, mspeedY);
					patternXY->SetMaxSpeedX(mspeedX * mspeedMul);
					patternXY->SetMaxSpeedY(mspeedY * mspeedMul);
				}
				else {
					StgMovePattern_XY_Angle* patternXYA = (StgMovePattern_XY_Angle*)pattern.get();
					double mspeedX = patternXYA->GetMaxSpeedX();
					double mspeedY = patternXYA->GetMaxSpeedY();
					double mspeedMul = speed / hypot(mspeedX, mspeedY);
					patternXYA->SetMaxSpeedX(mspeedX * mspeedMul);
					patternXYA->SetMaxSpeedY(mspeedY * mspeedMul);
				}
				goto lab_return;
			}
			}
		...
		obj->AddPattern(0, pattern);
lab_set:
		((StgMovePattern_Angle*)pattern.get())->SetMaxSpeed(speed);
	}
lab_return:
	return value();
}
...
gstd::value StgStageScript::Func_ObjMove_SetDestAtSpeed(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		double tx = argv[1].as_float();
		double ty = argv[2].as_float();
		double speed = argv[3].as_float();
...
gstd::value StgStageScript::Func_ObjMove_SetDestAtWeight(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		double tx = argv[1].as_float();
		double ty = argv[2].as_float();
		double weight = argv[3].as_float();
		double maxSpeed = argv[4].as_float();
...
gstd::value StgStageScript::Func_ObjMove_AddPatternC1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
...
gstd::value StgStageScript::Func_ObjMove_AddPatternC2(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
...
gstd::value StgStageScript::Func_ObjMove_AddPatternC3(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
...
gstd::value StgStageScript::Func_ObjMove_AddPatternC4(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		...
		double angOff = argv[8].as_float();
		double angVel = argv[9].as_float();
		double angAcc = argv[10].as_float();
...
gstd::value StgStageScript::Func_ObjMove_SetRelativePosition(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		double posX = argv[1].as_float();
		double posY = argv[2].as_float();
		obj->SetRelativePositionXY(posX, posY);

		if (DxScriptRenderObject* objR = dynamic_cast<DxScriptRenderObject*>(obj)) {
			objR->SetX(obj->GetPositionX());
			objR->SetY(obj->GetPositionY());
		}
	}
	return value();
}
gstd::value StgStageScript::Func_ObjMove_SetRelativeX(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		double pos = argv[1].as_float();
		obj->SetRelativePositionX(pos);
...
gstd::value StgStageScript::Func_ObjMove_SetRelativeY(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		double pos = argv[1].as_float();
		obj->SetRelativePositionY(pos);
...
gstd::value StgStageScript::Func_ObjMove_GetRelativeX(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	double pos = DxScript::g_posInvalidX_;
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj)
		pos = obj->GetRelativePositionX();
	return script->CreateFloatValue(pos);
}
gstd::value StgStageScript::Func_ObjMove_GetRelativeY(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	double pos = DxScript::g_posInvalidX_;
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj)
		pos = obj->GetRelativePositionY();
	return script->CreateFloatValue(pos);
}
...
gstd::value StgStageScript::Func_ObjMoveParent_Create(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	ref_unsync_ptr<StgMoveParentObject> obj(new StgMoveParentObject(stageController));
...
gstd::value StgStageScript::Func_ObjMoveParent_SetRotationSpeed(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		double angle = argv[1].as_float();
		obj->SetParentRotationSpeed(angle);
	}
	return value();
}
gstd::value StgStageScript::Func_ObjMoveParent_SetAutoDelete(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgMoveObject* obj = script->GetObjectPointerAs<StgMoveObject>(id);
	if (obj) {
		bool bAutoDelete = argv[1].as_boolean();
		obj->SetParentAutoDelete(bAutoDelete);
	}
	return value();
}
...
gstd::value StgStageScript::Func_ObjEnemy_Create(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (type == TypeObject::Enemy) {
		obj.reset(new StgEnemyObject(stageController));
	}
...
gstd::value StgStageScript::Func_ObjEnemy_GetInfo(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	switch (type) {
	case INFO_LIFE:
		return script->CreateFloatValue(obj->GetLife());
	case INFO_DAMAGE_RATE_SHOT:
		return script->CreateFloatValue(obj->GetShotDamageRate());
	case INFO_DAMAGE_RATE_SPELL:
		return script->CreateFloatValue(obj->GetSpellDamageRate());
	case INFO_SHOT_HIT_COUNT:
		return script->CreateFloatValue(obj->GetIntersectedPlayerShotCount());
	case INFO_DAMAGE_PREVIOUS_FRAME:
		return script->CreateFloatValue(obj->GetLifeDelta());
	case INFO_MAXIMUM_DAMAGE:
		return script->CreateFloatValue(obj->GetMaximumDamage());
	}
...
gstd::value StgStageScript::Func_ObjEnemy_AddIntersectionCircleA(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (auto obj = ref_unsync_ptr<StgEnemyObject>::Cast(script->GetObject(id))) {
		float px = argv[1].as_float();
		float py = argv[2].as_float();
		float radius = argv[3].as_float();
	...
	if (auto obj = ref_unsync_ptr<StgEnemyObject>::Cast(script->GetObject(id))) {
		...
		for (auto itr = listIntersection->cbegin(); itr != listIntersection->cend(); ++itr) {
			if (!itr->expired()) {
				...
				listRes.push_back(script->CreateFloatArrayValue(listValue, 3U));
			}
		}
	}
...
gstd::value StgStageScript::Func_ObjEnemyBossScene_GetInfo(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj == nullptr) {
		...
		case INFO_ACTIVE_STEP_LIFE_RATE_LIST:
			return script->CreateFloatArrayValue((int*)nullptr, 0);
		}
		return value();
	}
	...
	case INFO_REMAIN_STEP_COUNT:
		return script->CreateFloatValue(obj->GetRemainStepCount());
	case INFO_ACTIVE_STEP_LIFE_COUNT:
		return script->CreateFloatValue(obj->GetActiveStepLifeCount());
	case INFO_ACTIVE_STEP_TOTAL_MAX_LIFE:
		return script->CreateFloatValue(obj->GetActiveStepTotalMaxLife());
	case INFO_ACTIVE_STEP_TOTAL_LIFE:
		return script->CreateFloatValue(obj->GetActiveStepTotalLife());
	case INFO_ACTIVE_STEP_LIFE_RATE_LIST:
	{
		std::vector<double> listD = obj->GetActiveStepLifeRateList();
		return script->CreateFloatArrayValue(listD);
	}
	case INFO_IS_LAST_STEP:
	{
...
gstd::value StgStageScript::Func_ObjShot_SetIntersectionLine(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj && obj->GetDelay() <= 0) {
		...
		StgIntersectionManager* intersectionManager = stageController->GetIntersectionManager();
		float px1 = argv[1].as_float();
		float py1 = argv[2].as_float();
		float px2 = argv[3].as_float();
		float py2 = argv[4].as_float();
		float width = argv[5].as_float();
		DxWidthLine line(px1, py1, px2, py2, width);
...
gstd::value StgStageScript::Func_ObjShot_SetAngleRounding(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgShotObject* obj = script->GetObjectPointerAs<StgShotObject>(id);
	if (obj)
		obj->SetAngleRounding(Math::DegreeToRadian(argv[1].as_float()));
	return value();
}
...
gstd::value StgStageScript::Func_ObjShot_SetDelayScaleParameter(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		...
		delay->scale = D3DXVECTOR3(argv[1].as_float(), argv[2].as_float(), argv[3].as_float());
	}
	return value();
}
gstd::value StgStageScript::Func_ObjShot_SetDelayAlphaParameter(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		StgShotObject::DelayParameter* delay = obj->GetDelayParameter();
		delay->alpha = D3DXVECTOR3(argv[1].as_float(), argv[2].as_float(), argv[3].as_float());
	}
	return value();
}
...
gstd::value StgStageScript::Func_ObjLaser_SetInvalidLength(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgLaserObject* obj = script->GetObjectPointerAs<StgLaserObject>(id);
	if (obj) {
		float start = argv[1].as_float();
		float end = argv[2].as_float();
...
gstd::value StgStageScript::Func_ObjLaser_GetLength(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatValue(length);
}
gstd::value StgStageScript::Func_ObjLaser_GetRenderWidth(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatValue(width);
}
...
gstd::value StgStageScript::Func_ObjStLaser_SetDelayScale(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	StgStraightLaserObject* obj = script->GetObjectPointerAs<StgStraightLaserObject>(id);
	if (obj) {
		D3DXVECTOR2 scale = D3DXVECTOR2(argv[1].as_float(), argv[2].as_float());
...
gstd::value StgStageScript::Func_ObjCrLaser_GetNodePosition(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	return script->CreateFloatArrayValue(res, 2U);
}
...
gstd::value StgStageScript::Func_ObjCrLaser_GetNodeWidthScale(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
...
gstd::value StgStageScript::Func_ObjCrLaser_SetNode(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		StgCurveLaserObject::LaserNode* ptr = (StgCurveLaserObject::LaserNode*)argv[1].as_int();
		if (ptr && ptr->parent == obj) {
			float x = argv[2].as_float();
			float y = argv[3].as_float();
			float angle = Math::DegreeToRadian(argv[4].as_float());
			D3DCOLOR color = argv[5].as_int();

			float width = (argc == 7) ? argv[6].as_float() : 1.0f;
...
gstd::value StgStageScript::Func_ObjCrLaser_SetNodeAngle(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		StgCurveLaserObject::LaserNode* ptr = (StgCurveLaserObject::LaserNode*)argv[1].as_int();
		if (ptr && ptr->parent == obj) {
			float angle = Math::DegreeToRadian(argv[2].as_float());
			D3DXVECTOR2 rMove = D3DXVECTOR2(-sinf(angle), cosf(angle));

			ptr->vertOff[0] = { rMove.x, rMove.y };
			ptr->vertOff[1] = { -rMove.x, -rMove.y };
		}
	}
	return value();
}
gstd::value StgStageScript::Func_ObjCrLaser_SetNodeWidthScale(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = argv[0].as_int();
	StgCurveLaserObject* obj = script->GetObjectPointerAs<StgCurveLaserObject>(id);
	if (obj) {
...
gstd::value StgStageScript::Func_ObjCrLaser_AddNode(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		...
		float angle = Math::DegreeToRadian(argv[3].as_float());
		D3DCOLOR color = argv[4].as_int();

		float width = argc == 6 ? argv[5].as_float() : 1.0f;
...
gstd::value StgStageScript::Func_ObjPlayer_AddIntersectionCircleA1(gstd::script_machine* machine, int argc, const gstd::value* argv) {
	...
	if (obj) {
		float px = argv[1].as_float();
		float py = argv[2].as_float();
		float rHit = argv[3].as_float();
		float rGraze = argv[4].as_float();
	...
	if (objPlayer) {
		if (stageController->GetShotManager()->GetShotCountAll() < StgShotManager::SHOT_MAX) {
			...
			if (id != ID_INVALID) {
				...
				double speed = argv[2].as_float();
				double angle = argv[3].as_float();
				double damage = argv[4].as_float();
				double life = argv[5].as_float();
				int idShot = argv[6].as_int();
